...
import logo from './assets/global-sr-logo.png'; // Assuming you have a logo image
        ...
        <div className="flex justify-between h-16 items-center">
          <Link to="/" className="flex flex-col leading-none">
            <div className="flex items-center space-x-1">
              <img src={logo} alt="Global SR Logo" className="h-10 w-auto sm:h-16" />
              <div className="flex flex-col">
                <span className="text-xl md:text-3xl font-extrabold tracking-tight text-blue-950">
                  GLOBAL SR
                </span>
                <span className="text-[10px] md:text-xs text-blue-600 tracking-[0.2em] font-bold uppercase">
